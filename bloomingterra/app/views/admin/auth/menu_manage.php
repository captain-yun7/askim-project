...
<div id="contents">
	...
	<div class="terms_privecy_box">
		<dl>
			<dt>- 서비스 사례 카테고리를 메뉴관리에서 사용할 경우 주의사항</dt>
			<dd>
			사용자 페이지(홈페이지) 상단 메뉴 활성화 기능으로 1차 메뉴의 하위 메뉴에 접속하게 되면 해당 1차 메뉴가 활성화 됩니다. <br>
			"서비스 사례 관리 > 카테고리관리" 에서 등록한 서비스 사례 카테고리를 메뉴관리에 등록할 경우, <em class="point">하위 카테고리가 있는 1차 카테고리 한 개</em>만 등록이 가능합니다. <br><br>

			*** 1차 메뉴에 하위 카테고리가 없는 1차 서비스 사례 카테고리를 2개 이상 사용해야 할 경우, 소스상에서 별도로 상단메뉴 활성화 처리를 script로 진행해주셔야 합니다.<br><br>
			</dd>
		</dl>
	</div>
</div>
