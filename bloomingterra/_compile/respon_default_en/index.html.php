<?php /* Template_ 2.2.8 2026/02/19 16:54:43 /gcsd33_bloomingterra/www/data/skin/respon_default_en/index.html 000025747 */ ?>
...
@media only screen and (max-width:860px){
	#smooth-wrapper:before{width:100%;height:100vh;content:"";background:url('/data/skin/respon_default_en/images/skin/section_01_bg.jpg')no-repeat center;background-size:cover;position: fixed;top:0;left:0;z-index:0;}
}
</style>
		...
		<div class="main_content">
			...
			<div class="sec01 ver_pc">
				<div class="layout lay01">
					<!-- <div class="img">
						<img src="/data/skin/respon_default_en/images/skin/obj_globe.png" alt="globe">
					</div> -->
				...
				<div class="layout lay03" id="mainAbout">
					...
					<div class="wo2">Step into the spotlight with the most impactful OOH media network</div>
					<dl class="wo3">
						<dt>
							<div>
						...
						<dd>
							<div>
								Step into the spotlight with the most impactful OOH media network
							</div>
						</dd>
					</dl>
				</div>
					...
					<ul class="layout">
						<li class="l1">
							<div class="tbx">
								...
								<h3 class="h3">HOT SPOT CAMPAIGNS</h3>
								<h4 class="h4" data-count="100"><span>0</span><sup>+</sup></h4>
								<p class="p">We constantly read the fast changing <br>market trend and conduct campaigns <br>in TOP TRENDY markets in Global such as <br>Los Angeles, hollywood, Las Vegas, New York.</p>
							</div>
							<div class="back">
								<div class="img_box">
									<img class="bu01" src="/data/skin/respon_default_en/images/skin/campaign_bg.png" alt="">
									<img class="bu02" src="/data/skin/respon_default_en/images/skin/campaign01.png" alt="">
									<img class="bu03" src="/data/skin/respon_default_en/images/skin/campaign02.png" alt="">
									<img class="bu04" src="/data/skin/respon_default_en/images/skin/campaign03.png" alt="">
									<img class="bu05" src="/data/skin/respon_default_en/images/skin/campaign04.png" alt="">
									<img class="bu06" src="/data/skin/respon_default_en/images/skin/campaign05.png" alt="">
								</div>
								<div class="obj">
									<img class="obj01" src="/data/skin/respon_default_en/images/skin/camp_obj01.png" alt="">
									<img class="obj02" src="/data/skin/respon_default_en/images/skin/camp_obj02.png" alt="">
								</div>
								<div class="circle">
						...
						<li class="l2">
							<div class="block">
								<div class="lob">
									<div class="item">
										<div class="los">
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner01_01.png" alt="디올"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner01_02.png" alt="포르쉐"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner01_03.png" alt="구글"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner01_04.png" alt="카르티에"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner01_05.png" alt="나이키"></div></div>
										</div>
										<div class="los">
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner01_01.png" alt="디올"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner01_02.png" alt="포르쉐"></div></div>
									...
									<div class="item">
										<div class="los">
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner02_01.png" alt="버버리"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner02_02.png" alt="벤츠"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner02_03.png" alt="보테가"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner02_04.png" alt="넷플릭스"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner02_05.png" alt="무신사"></div></div>
										</div>
										<div class="los">
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner02_01.png" alt="버버리"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner02_02.png" alt="벤츠"></div></div>
									...
									<div class="item">
										<div class="los">
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner03_01.png" alt="삼성"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner03_02.png" alt="예거"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner03_03.png" alt="올리브영"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner03_04.png" alt="키엘"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner03_05.png" alt="프라다"></div></div>
										</div>
										<div class="los">
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner03_01.png" alt="삼성"></div></div>
											<div class="logo"><div><img src="/data/skin/respon_default_en/images/skin/partner03_02.png" alt="예거"></div></div>
							...
							<div class="tbx">
								...
								<h3 class="h3">GLOBAL BRAND PARTNERS</h3>
								<h4 class="h4" data-count="50"><span>0</span><sup>+</sup></h4>
								<p class="p">We have collaborated with <br>more than 50 global brands, <br>from famous domestic brands to global <br>luxury brands all around the world.</p>
							</div>
						</li>
					</ul>
				</div>
					...
					<div class="horizon">
						<div class="layer">
							<div class="des">
								...
								<h3><strong>Deliver Unique Experience</strong></h3>
								<p>Bloomingterra is an outdoor advertising company specialized <br>in ambient advertising that utilizes various spaces and structures. <br>We bring a brand's message into the daily lives of people, <br>creating a unique experience.</p>
							</div>
						</div>
						<div class="layer">
<?php $this->print_("experience_display",$TPL_SCP,1);?>
				...
				<div class="sec05 horizon_wrap" id="sec05">
					...
					<div class="horizon">
						<div class="layer">
							<div class="des">
								<span>VALUE</span>
								<h3><strong>Create Value through Success</strong></h3>
								<p>Bloomingterra focuses on value-centered business. <br>We bring life and value to overlooked spaces and buildings <br>by delivering a brand's message through engaging content.</p>
							</div>
						</div>
						<div class="layer">
<?php $this->print_("value_display",$TPL_SCP,1);?>
			...
			<div class="sec06" id="sec06">
				...
				<div class="lasy ver_pc">
					<div class="title">
						<h3>SERVICE</h3>
						<p>Take a look at Bloomingterra’s campaign projects.</p>
					</div>
<?php $this->print_("service_display",$TPL_SCP,1);?>
