<?php /* Template_ 2.2.8 2026/02/19 16:57:50 /gcsd33_bloomingterra/www/data/skin/respon_default_en/layout/board/list_gallery_01.html 000004469 */ ?>
...
<?php if($TPL_V1["is_read"]=='s'){?><a href="/board/board_secret?code=<?php echo $TPL_V1["code"]?>&no=<?php echo $TPL_V1["no"]?>&page=view" alt="<?php echo $TPL_V1["title"]?>"><?php }else{?><a href="/board/board_view?code=<?php echo $TPL_V1["code"]?>&no=<?php echo $TPL_V1["no"]?>" alt="<?php echo $TPL_V1["title"]?>"><?php }?></a>
		<div class="thumb">
			<img src="<?php echo _UPLOAD?>/board/<?php echo $TPL_V1["upload_path"]?>/<?php echo $TPL_V1["board_file"]["thumbnail"][ 0]['fname']?>" alt="<?php echo $TPL_V1["title"]?>" onerror="this.src='/data/skin/respon_default_en/images/common/noimg.gif'">
		</div>
		<div class="txt_info">
			<b>공지</b>
			<div class="board_tit">
				<div class="board_ico">
<?php if($TPL_V1["display_read"]=='s'){?><img src="/data/skin/respon_default_en/images/common/icon_secret.gif" alt="비밀글"><?php }?>
...
<?php }?>
				...
				<span><?php echo date_format(date_create($TPL_V1["regdt_date"]),'Y.m.d')?></span>
			</div>
		</div>
...
<p class="nodate">There is No Posts.</p>
<?php }?>
<?php }?>
