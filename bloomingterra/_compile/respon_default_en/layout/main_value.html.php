<?php /* Template_ 2.2.8 2026/02/19 16:57:44 /gcsd33_bloomingterra/www/data/skin/respon_default_en/layout/main_value.html 000001076 */ ?>
<?php if($TPL_VAR["value_info"]['mainview']=='y'){?>
<ul class="list">
<?php if(isset($TPL_VAR["value_list"]['board_list'])){?>
<?php if(is_array($TPL_R1=$TPL_VAR["value_list"]['board_list'])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
	<li class="">
