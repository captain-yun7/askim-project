<?php /* Template_ 2.2.8 2024/03/20 15:05:09 /home/bloomingterra/www/data/skin/respon_default/layout/goods/list.html 000001438 */ ?>
...
<?php if(is_array($TPL_R1=$TPL_VAR["goods_list"]['goods_list'])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
	<li>
		<div class="cont">
			...
			<div class="thumb">
				<img src="/upload/goods/img2/<?php echo $TPL_V1["img2"]?>" onerror="this.src='/data/skin/respon_default/images/common/noimg.gif'" alt="<?php echo $TPL_V1["name"]?>">
			</div>
			<div class="info">
				<dl>
