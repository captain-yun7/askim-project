<?php /* Template_ 2.2.8 2024/03/11 13:59:34 /home/bloomingterra/www/data/skin/respon_default/layout/board/list_qna.html 000003886 */ ?>
...
<table class="bbs_list" summary="게시글 제목, 작성자, 작성일, 조회수, 게시글 내용 등..">
	...
	<colgroup>
		<col width="7%">
		<col >
		<col width="12%" class="td_wide">
		<col width="14%" class="td_wide">
	</colgroup>
	<thead>
		<tr>
			<th scope="col">번호</th>
			<th scope="col">제목</th>
			<th scope="col" class="td_wide">작성자</th>
			<th scope="col" class="td_wide">작성일</th>
		</tr>
	</thead>
	<tbody>
...
<?php }?>
			...
			<td class="td_wide"><?php echo $TPL_V1["name"]?></td>
			<td class="td_wide"><?php echo $TPL_V1["regdt_date"]?></td>
		</tr>
<?php }}?>
<?php }?>
<?php }?>
