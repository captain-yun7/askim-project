<?php /* Template_ 2.2.8 2024/11/26 11:40:08 /home/bloomingterra/www/data/skin/respon_default/goods/goods_view.html 000007350 */ 
...
<?php if(is_array($TPL_R1=$TPL_VAR["goods_view"]['goods_view']['detail_img'])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
					<img src="<?php echo _UPLOAD?>/goods/detail_img/<?php echo $TPL_V1?>" onerror="this.src='/data/skin/respon_default/images/common/noimg.gif'">
<?php }}?>
			</div>
...
<?php }?>
				...
				<dl class="info desc">
					<dt>Date</dt>
					<dd><?php echo date_format(date_create($TPL_VAR["regdt_date"]),'Y.m.d')?></dd>
				</dl>
			</div>
...
<?php }?>
		...
		<div class="view_contact">
			<div class="cont">
				<h2>CONTACT</h2>
				<h5>블루밍테라는 브랜드와 고객에게 특별한 경험을 선물합니다.</h5>
				<div class="btn_send">
					<a href="../board/board_write?code=inquiry"><span>문의하기</span></a>
				</div>
			</div>
		</div>
...
<?php }?>
		...
		<div class="dn">
			<div class="info">
				<dl>
					<dt class="thumb_box"><img src="<?php echo _UPLOAD?>/goods/img1/<?php echo $TPL_VAR["goods_view"]['goods_view']['img1']?>" onerror="this.src='/data/skin/respon_default/images/common/noimg.gif'" alt="<?php echo $TPL_VAR["goods_view"]['goods_view']['name']?>"></dt>
