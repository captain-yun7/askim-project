...
⚠️ 2026-05-14: board_view 마크업의 .related_posts 섹션은 디자인 시안 대기로 hide 처리됨
   (DB 기능 related_no1/2은 보존). 시안 확정 후 마크업 복원되면 이 skip 제거.
"""
import pymysql
import pytest

pytestmark = pytest.mark.skip(reason="related_posts 마크업이 디자인 시안 대기 중 hide됨. 시안 확정 후 활성화 (DB 기능은 유지).")
