...
echo '<link href="/comm/jquery-ui/style_web.css" rel="stylesheet" type="text/css">'.PHP_EOL;
echo '<script type="text/javascript" src="/comm/jquery-ui/jquery-ui-1.11.3.min.js"></script>'.PHP_EOL;
echo '<script type="text/javascript" src="/comm/js/datepicker.js"></script>'.PHP_EOL;
