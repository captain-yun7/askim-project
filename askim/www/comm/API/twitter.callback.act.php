...
if($browser['name']=="Google Chrome"){
	$name = $_COOKIE['twitter_username'];
}else{
	$name = iconv("EUC-KR","UTF-8",$_COOKIE['twitter_username']);
}


if(!empty($_COOKIE['twitter_id'])){

	$_SESSION['wiz_session']['id']          = "TT".$_COOKIE['twitter_id'];
	$_SESSION['wiz_session']['passwd']      = $_COOKIE['twitter_id'];
