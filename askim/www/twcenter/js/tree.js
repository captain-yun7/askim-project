/** JavaScript Library for Tree Component*** @author*		Dion(Enet corp. Agent-Team). No rights reserved...*//*** Constant for Tree*/var TREE_NODE_ROOT_IMG = "/twcenter/manage/image/tree/Common_TreeNode_FolderRoot.gif";var TREE_FOLDER_OPEN_IMG = "/twcenter/manage/image/tree/Common_TreeNode_FolderOpen.gif";var TREE_FOLDER_CLOSED_IMG = "/twcenter/manage/image/tree/Common_TreeNode_FolderClosed.gif";var TREE_LINE_OPEN_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineNodeOpen.gif";var TREE_LINE_CLOSED_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineNodeClosed.gif";var TREE_LINE_LAST_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineLast.gif";var TREE_LINE_LAST_OPEN_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineLastOpen.gif";var TREE_LINE_LAST_CLOSED_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineLastClosed.gif";var TREE_LINE_NODE_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineNode.gif";var TREE_LINE_VERT_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineVert.gif";var TREE_LINE_BLANK = "/twcenter/manage/image/tree/Common_TreeNode_Blank.gif";
var TREE_NODE_LEAF_IMG = "/twcenter/manage/image/tree/Common_TreeNode_Note.gif";
var TREE_NODE_MMATOP_IMG= "/twcenter/manage/image/tree/MMAReport_Top_Root.gif";
/**
* Create Tree
*/
function Tree() {
...
{
	TREE_NODE_ROOT_IMG = "/twcenter/manage/image/tree/Common_TreeNode_FolderRoot.gif";
	TREE_FOLDER_OPEN_IMG = "/twcenter/manage/image/tree/Common_TreeNode_FolderOpen.gif";
	TREE_FOLDER_CLOSED_IMG = "/twcenter/manage/image/tree/Common_TreeNode_FolderClosed.gif";
	TREE_LINE_OPEN_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineNodeOpen.gif";
	TREE_LINE_CLOSED_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineNodeClosed.gif";
	TREE_LINE_LAST_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineLast.gif";
	TREE_LINE_LAST_OPEN_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineLastOpen.gif";
	TREE_LINE_LAST_CLOSED_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineLastClosed.gif";
	TREE_LINE_NODE_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineNode.gif";
	TREE_LINE_VERT_IMG = "/twcenter/manage/image/tree/Common_TreeNode_LineVert.gif";
	TREE_LINE_BLANK = "/twcenter/manage/image/tree/Common_TreeNode_Blank.gif";
	TREE_NODE_LEAF_IMG = "/twcenter/manage/image/tree/Common_TreeNode_Note.gif";
	TREE_NODE_MMATOP_IMG= "/twcenter/manage/image/tree/MMAReport_Top_Root.gif";
}
/**
* Add Node tree tree
*/
...
function TreeNode(text, fimage, oimage) {
	this.id = compManager.generateID();	this.text = text;
	this.oimage = oimage;
	this.fimage = fimage;
	this.action = null;
	this.nodes = new Array();
...
function treeNodeExpand() {
	...
	if(this.onExpand) {		execScripts(this.onExpand);
	}
}
...
function __treeNodeHideChild(objNode) {
	...
	for(var i=0; i<objNode.nodes.length; i++) {		__treeNodeHideChild(objNode.nodes[i]);
	}
}
/**
...
*/
function treeNodeGetFolderImage() {	if(this.selected) return this.oimage;
...
function treeNodeToHTML() {
	...
	*/
	...
	var szLineImg = "";
	if(this.depth() != 0) {		var iDepth = this.depth();
		var par = this.parent;
		...
		szHtml += szLineImg;		szHtml += "<td nowrap valign=middle><img width=19 height=16  id=" + this.id + "_signimage src=" + this.getSignImage() +
...
function treeNodeOnClick(id) {
	...
	event.cancelBubble = nodeComp.cancelBubble;	return false;
}
function treeNodeOnDblClick(id) {
	var nodeComp = compManager.get(id);
	var node = document.all[id];
	if(nodeComp.root) return;
	if(event.srcElement.id == id+"_text") {		if(nodeComp.expanded) nodeComp.shrink();
		else { nodeComp.expand(); }
	}
...
function treeNodeOnContextMenu(id) {
	...
	if(objNodeComp.context) {
		...
		objNodeComp.context.show();		if(objNodeComp.getRootTree().selectedNode != null) {
