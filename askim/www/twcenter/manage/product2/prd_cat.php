...
$(function() {
	$("#categoryShow").load("cat_list.php?catcode=<?php echo $catcode; ?>");
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
					<tr>
						...
						<td class="t_value padd" colspan="3">
							<input type="text" id="browser_title" value="<?php echo $site_info['prd2_browser_title']; ?>" size="80" class="input">
						</td>
					</tr>
					<tr>
						<td width="15%" align="left" class="t_name">메타네임(Description)</td>
						<td class="t_value padd" colspan="3">
							<textarea id="searchkey_de" rows="3" cols="120" class="textarea"><?php echo $site_info['prd2_searchkey_de']; ?></textarea>
					...
					<tr>
						...
						<td class="t_value padd" colspan="3">
							<textarea id="searchkey_cl" rows="3" cols="120" class="textarea"><?php echo $site_info['prd2_searchkey_cl']; ?></textarea>
					...
					<tr>
						...
						<td class="t_value padd" colspan="3">
							<textarea id="searchkey" rows="3" cols="120" class="textarea"><?php echo $site_info['prd2_searchkey']; ?></textarea>
