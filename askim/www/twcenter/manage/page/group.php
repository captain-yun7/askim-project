...
function grpDelete(idx) {
	if(confirm("삭제하시겠습니까?")) {
		document.location = "page_save.php?mode=grpdelete&idx=" + idx;
	}
}
function set_prior() {
...
?>
	<tr>
		...
		<td align="center">
	<form class="grp_frm" name="frm<?=$grp['idx']?>" method="post" action="./page_save.php">
