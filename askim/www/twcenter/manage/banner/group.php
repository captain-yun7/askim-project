...
function grpDelete(idx) {
	if(confirm("삭제하시겠습니까?")) {
		document.location = "banner_save.php?save=true&mode=grpdelete&idx=" + idx;
	}
}
function set_prior() {
	...
	frm.attr("action", "./banner_save.php");
...
?>
	<tr>
		...
		<td align="center">
	<form class="grp_frm" name="frm<?=$grp['idx']?>" method="post" action="./banner_save.php">
