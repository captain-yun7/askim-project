			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
				...
				<tr>
					...
					<tr>
						...
						<?php if($site_info['mobile_use'] == 'Y' && $site_info['mobile_show_use']=="Y"){ ?>
						...
						<?php }else{ ?>
							<input type="hidden" name="mobileShow" value="<?php echo $prd_row->mobileShow; ?>">
						<?php } ?>
						</td>
					</tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
				...
				<tr>
					...
					<td class="t_value padd">
						<input type="text" name="prd_br_title" value="<?=$prd_row->prd_br_title?>" size="80" class="input">
					</td>
				</tr>
				<tr>
					<td align="left" class="t_name">메타네임(Description)</td>
					<td class="t_value padd">
						<textarea name="prd_descript" rows="3" cols="120" class="textarea"><?php echo $prd_row->prd_descript ?></textarea>
				...
				<tr>
					...
					<td class="t_value padd">
						<textarea name="prd_classification" rows="3" cols="120" class="textarea"><?php echo $prd_row->prd_classification ?></textarea>
				...
				<tr>
					...
					<td class="t_value padd">
						<textarea name="prd_keywords" rows="3" cols="120" class="textarea"><?php echo $prd_row->prd_keywords ?></textarea>
