...
for($i=1; $i<=$last_month_day; $i++){
	...
	$g_day_play           = (strlen($i)==1) ? "0".$i : $i;
	$t_year_month_day_sql = " and $t_date like '".$t_year."-".$t_month."-".$g_day_play."%' ";
...
function excelDown(){
	location.href="_total_day_analy_excel.php?<?php echo $param; ?>";
}
		...
		<table border="0" cellspacing="0" cellpadding="2">
		  <tr>
		    ...
		    <td valign="bottom" class="tit">일별매출</td>
		    <td width="2"></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td class="tit_sub"><img src="../image/ics_tit.gif" align="absmiddle"> <?=$t_year?>년 <?=$t_month?>월 총 매출통계</td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td class="tit_sub"><img src="../image/ics_tit.gif" align="absmiddle"> <?=$t_year?>년 <?=$t_month?>월 일별 매출통계</td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="t_style">
			<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="t_style">
			...
			?>
			<tr>
				<td rowspan="3" class="t_name_analy"><?=$day_play?>일</td>
				<td class="t_name_analy">PC</td>
				<td class="t_value_analy"><?=number_format($pc_total_order_OR)?></td>
				<td class="t_value_analy"><?=number_format($pc_total_price_OR)?></td>
				<td class="t_value_analy"><?=number_format($pc_total_no_price_OR)?></td>
