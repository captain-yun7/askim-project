...
$conn_pc_sql = "
	...
	where 1
		...
		$t_year_sql $t_paymethod_sql and (status='RD' or status='RD' or status='CD' or status='CC') and connect_type='PC'
...
$conn_mo_sql = "
	...
	where 1
		...
		$t_year_sql $t_paymethod_sql and (status='RD' or status='RD' or status='CD' or status='CC') and connect_type='M'
...
?>
		...
		<table width="100%" cellspacing="1" cellpadding="3" border="0">
			<tr>
				<td align="center">
					...
					<a href="<?=$PHP_SELF?>"><input type="button"  value="전체통계" class="search_default"></a>
				</td>
			</tr>
		</table>
		</form>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td class="tit_sub"><img src="../image/ics_tit.gif" align="absmiddle"> <?=$t_year?>년 총 매출통계</td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="t_style">
			<tr>
				...
				<td colspan='2' class="t_value_main_can2">주문취소</td>
				<td colspan='2' class="t_value_main_can">반품/교환</td>
			</tr>
			<tr>
				...
				<td class="t_value_main_can2">건수</td>
				<td class="t_value_main_can2">금액</td>
			...
			for($i=1; $i<=12; $i++){
				...
				$conn_pc_sql = "
					...
					where 1
						...
						$t_year_month_sql $t_paymethod_sql and (status='RD' or status='RD' or status='CD' or status='CC') and connect_type='PC'
				...
				$conn_mo_sql = "
					...
					where 1
						...
						$t_year_month_sql $t_paymethod_sql and (status='RD' or status='RD' or status='CD' or status='CC') and connect_type='M'
