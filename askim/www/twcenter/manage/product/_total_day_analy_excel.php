...
$t_year_sql = " and $t_date like '".$t_year."-".$t_month."%' ";
...
$filename = "total_day_analy_".date('Ymd').".xls";
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-size:12px; background-color: #e1e1e1;">
	...
	for($i=1; $i<=$last_month_day; $i++){
		...
		$day_play           = (strlen($i)==1) ? "0".$i : $i;
		$t_year_month_day_sql = " and $t_date like '".$t_year."-".$t_month."-".$day_play."%' ";
	...
	?>
	<tr>
		<td rowspan="3" style="font-size:12px; font-weight:600; color: #333; background: #f5f5f5 !important; line-height: 15px; height:33px; text-align:center;"><?=$day_play?>일</td>
	...
	<tr>
		...
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_order_OR)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_price_OR)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_no_price_OR)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_deliver_price)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px">0</td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_coupon_use)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_reserve_use)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_price)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_order_OC)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_price_OC)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_order_EX)?></td>
		<td style="font-size:12px; color: #000000; background: #f0f7ff !important; line-height: 20px; text-align:right; padding-right:5px"><?=number_format($total_price_EX)?></td>
	</tr>
	<?
	}
	## 주문접수
