...
echo "id{$tab}title{$tab}price_pc{$tab}link{$tab}image_link{$tab}category_name1{$tab}category_name2{$tab}category_name3{$tab}category_name4{$tab}brand{$tab}maker{$tab}origin{$tab}point{$tab}shipping{$tab}class{$tab}update_time";
...
while($db_rows = sql_fetch_arr($db_Query)){		
	...
	echo "\n{$db_rows['prdcode']}{$tab}{$prdname}{$tab}{$db_rows['sellprice']}{$tab}{$prdUrl}{$tab}{$imgUrl}{$tab}{$cate_1}{$tab}{$cate_2}{$tab}{$cate_3}{$tab}{$cate_4}{$tab}{$brand}{$tab}{$maker}{$tab}{$origin}{$tab}{$reserve}{$tab}{$del_pay}{$tab}{$show_class}{$tab}{$update_time}";
