...
var GB = {
    ...
    popupWindow: {
        ...
        Link :          {tmpl : 'link.html',            width : 400, title : '하이퍼링크'},
...
function setConfig() {
    var config = {
        ...
        imgMaxWidth         : 1530,      // 사진 최대 가로 크기, 이 크기 보다 크면 리사이징 처리
        imgResizeMinLimit   : 32,       // 사진 리사이징의 사용자 직접 입력 값이 이 값 보다 작으면, 이 값으로 설정
        imgResizeSelected   : 1530,      // 사진 리사이징의 선택 입력 폼의 기본 선택 값
        imgResizeValue      : [120, 240, 320, 640, 1530, -1], // -1 = 사용자 직접 입력
        imgSetAttrAlt       : true,
        ...
        useCut              : true,
        usePaste            : true,
        usePasteFromWord    : false, //MS 워드 붙이기 제외 (2021-05-14)
        useSelectAll        : true,
        ...
        useJustifyFull      : true,
        useBold             : true,
        useOrderedList      : false, //문단번호 제외 (2021-05-14)
        useUnOrderedList    : false, //글머리표 제외 (2021-05-14)
        useOutdent          : false, //여백설정 제외 (2021-05-14)
        useIndent           : false, //여백설정 제외 (2021-05-14)
        useFontName         : false, //폰트스타일 제외 (2021-05-14)
        useFormatBlock      : false, //폰트스타일 제외 (2021-05-14)
        useFontSize         : true,
        useLineHeight       : true,
        useBackColor        : true,
        useForeColor        : true,
        ...
        useLink             : true,
        useUnLink           : true,
        useFlash            : false, //동영상 제외 (2021-05-14)
        useMedia            : false,
        useImage            : true,
        useImageUrl         : false,
        useSmileyIcon       : true,
        useHR               : false, //가로선 제외 (2021-05-14)
        useTable            : true,
        useModifyTable      : true,
        useMap              : false, //지도 제외 (2021-05-14)
        useTextBlock        : true,
        useFullScreen       : true,
        usePageBreak        : false
    },
        ...
        switch (evt.keyCode) {
			...
			case 9 :
				if(this.cheditor.mode == "rich") {
					console.log("tab");
					console.log($(this.cheditor.container).parent());
					console.log(this.cheditor.container.nextSibling.nextSibling);
				}
				break;
        }
    },
            ...
            if (cmd === 'PasteFromWord') {
                ...
                switch (cmd) {
                    ...
                    case 'JustifyFull' :
                        ...
                        if (node&& pNode.nodeName.toLowerCase() !='body') {
