...
while($row = sql_fetch_arr($result)){
	...
	if(file_exists(WIZHOME_PATH."/data/product2/".$row['prdimg_M1']) && !empty($row['prdimg_M1'])) 
		$prdimg = "/twcenter/data/product2/".$row['prdimg_M1'];		// img
	else $prdimg = "/twcenter/images/noimg_R.gif";

	if($purl != "") $prdlink = "/m/".$purl."?ptype=view&prdcode=".$row['prdcode']."&catcode=".$row['catcode'];
