...
<?php
	...
	$result2 = query($sql) or error("sql_error");
    ...
    if($row->de_type == "IMG")
      $ban_content = "<img src=/twcenter/data/banner/".$row->de_img." border=0 ".$onClick.">";
    else
      $ban_content = "<table cellpadding=0 cellspacing=0 border=0><tr><td ".$onClick.">".stripslashes($row->de_html)."</td></tr></table>";
