...
if(
	($mem_level == "0") ||																																		// 전체관리자
	($bbs_info['bbstadmin'] != "" && strpos($bbs_info['bbsadmin'],$wiz_session['id']) !== false)	||	// 게시판관리자
			        ...
			        <tr>
			          ...
			          <td class="t_value">			          
									...
									<select name="status" class=select>
									    <option>:: 선택하세요 ::</option>
										<option value="1" <? if($row['status'] == "1") echo "selected"; ?>>채용중</option>
										<option value="2" <? if($row['status'] == "2") echo "selected"; ?>>마감 </option>
									</select>
			          </td>
			        </tr>
			      </table>
