...
if($mode == "view")
	$cancel_btn = "<input type=button value=취소 class='btn_w' onClick=document.location='?ptype=list&code=$code&$menucodeParam' style='cursor:pointer' alt='취소' />";
else
...
if(
	...
	$input_passwd = "<input type='password' name='passwd' size='20' class='input input_s' title='비밀번호 입력' />";
