...
var GB = {
    ...
    popupWindow: {
        ...
        ImageUpload :   {tmpl : 'image.html',           width : 260, title : '내 PC 사진 넣기'},
    ...
    fontSize: {
        pt: [7, 8, 9, 10, 11, 12, 14, 16, 18, 20, 22, 24, 26, 28],
        px: [9, 10, 11, 12, 14, 16, 18, 20, 22, 24, 26, 28, 36, 48]
    },
    formatBlock: {
        P: '일반 텍스트',
        H1: '제목 1',
...
function setConfig() {
    var config = {
        ...
        imgResizeValue      : [120, 240, 320, 640, 1180, -1], // -1 = 사용자 직접 입력
        imgSetAttrAlt       : false,
...
cheditor.prototype = {
    ...
    modifyImage : function (img) {
        ...
        if (self.undefined(self.editImages[img.src])) {
            // 171018-이미지 등록시 가로, 세로 사이즈 노출안 되게
			/*self.editImages[img.src] = { width: img.width, height: img.height };*/
        }

		div.appendChild(document.createElement('br'));	// br 추가
        //div.appendChild(document.createTextNode('\u00a0\u00a0Alt:'));
		div.appendChild(document.createTextNode('Alt:'));
        inputAlt = createInputForm('text', 'inputAlt', '', 'user-input-alt input01');
        ...
        inputTitle = createInputForm('text', 'inputTitle', '', 'user-input-alt input02');
