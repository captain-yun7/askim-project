        ...
        (function () {
            if (!elem) {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    div = document.createElement('div');
                    label = document.createElement('label');
                    text = size > 48 ? '가' : (size > 28 ? '가나' : '가나다라');
                ...
                self.createWindow(170, outputHtml);
                outputHtml.style.height = '200px';
