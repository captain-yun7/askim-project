...
<div class="order_cancel">
	<h5>주문취소<a href="javascript:window.close();"><img src="<?php echo $skin_dir ?>/image/id_check_close.gif" width="21" height="21" border="0"></a></h5>
	...
	<form name="frm" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" onSubmit="return inputCheck(this);">
	    ...
	    <tr><td colspan="2" bgcolor="#333333" height="1"></td></tr>
			<tr>
				<td class="tit"  width="30%" style="padding:13px 0">주문번호</td>
				<td class="val" width="70%"><?php echo $orderid ?></td>
			</tr>
			<tr><td height="1" colspan="4" bgcolor=#d7d7d7></td></tr>
			<tr>
				<td class="tit"  width="30%" style="padding:13px 0">취소사유</td>
				<td class="val" style="padding:8px"><textarea rows="6" cols="10" name="cancelmsg" class="input" style="width:100%"></textarea></td>
			</tr>
			<tr><td height="1" colspan="4" bgcolor=#d7d7d7></td></tr>
			<tr>
				<td colspan=2 align=center height="50">
					<input type="image" src="<?php echo $skin_dir ?>/image/btn_confirm.gif"> <img src="<?php echo $skin_dir ?>/image/btn_cancel.gif" onClick="self.close()" style="cursor:hand">
				</td>
			</tr>
		</table>
		</form>
